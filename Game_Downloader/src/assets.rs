...
pub const VELOREN_LOGO: &[u8] = include_bytes!("../assets/images/v_logo.png");
pub const PIXELLAND_LOGO: &[u8] = include_bytes!("../assets/images/p_logo.png");
pub const STAR_ALLIANCE_LOGO: &[u8] = include_bytes!("../assets/images/sa.png");

pub const VOXELLAND_BACKGROUND: &[u8] = include_bytes!("../assets/images/bg_1.jpg");

pub const VELOREN_ICON: &[u8] = include_bytes!("../assets/favicon.ico");
