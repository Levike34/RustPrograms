...
const LIGHT_PURPLE: Color = Color::from_rgb(0.159, 0.90, 0.253);
const DARK_PURPLE: Color = Color::from_rgb(0.18, 0.10, 0.2);
...
impl pick_list::StyleSheet for ServerPickList {
    fn menu(&self) -> pick_list::Menu {
        pick_list::Menu {
            ...
            selected_background: Background::Color(DARK_PURPLE),
...
// pub struct Game;
// impl container::StyleSheet for Game {
//     fn style(&self) -> container::Style {
//         container::Style {
//             text_color: Some(LIGHT_GREY),
//             background: Some(Background::Color(DARKER_SEA_GREEN)),
...
//     fn hovered(&self) -> container::Style {
//         let active = self.active();
